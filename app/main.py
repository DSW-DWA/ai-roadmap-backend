...
@app.post("/roadmap/from-files", response_model=Roadmap, summary="Сгенерировать SQL-роадмап из файлов")
async def roadmap_from_files(files: List[UploadFile] = File(..., description="До 5 файлов, ≤5 МБ каждый")):
